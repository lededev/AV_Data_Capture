...
def check_update(local_version):
    htmlcode = ""
    try:
        htmlcode = get_html("https://api.github.com/repos/lededev/AV_Data_Capture/releases/latest")
    except:
    ...
    if local_version < remote:
        ...
        print("[*]https://github.com/lededev/AV_Data_Capture/releases")
        print("[*]======================================================")
...
def argparse_function(version: str, release: str) -> typing.Tuple[str, str, str, str, bool, bool]:
    ...
    parser.add_argument("-f", "--failed-output-folder", default='', nargs='?', help="Failed output folder.")
...
def close_logfile(logdir: str):
    ...
    # python3 ./avdc.py -zgic1 -o $LOGDIR
    ls $LOGDIR
    # rm -rf $LOGDIR
    """
